  ...
  var vm = new Vue({
      ...
      lineData: [
        {
          ...
          endOffset: [0, 0, 0.2],
          type: 'ModelCylinder',
          texture: './image/redyellowgrd.png',
          textureSpeed: 0.5,
          width: 0.05,
          shapeType: 'straight',
          curvature: 0,
    ...
    methods: {
      ...
      getToken() {
        ...
        axios({
          method: 'post',
          url: 'https://www.tuguan.net/api/user/v1/visitorScene/' + sceneConfig.lineUrl1,
        }).then((res) => {
        ...
        window.appInstance.initService(
          {
            ...
            mode: 'scene',
            token: token,
            url: 'https://www.tuguan.net/publish/scene/api/' + sceneConfig.lineUrl1, //模型地址
