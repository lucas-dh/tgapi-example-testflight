    ...
    methods: {
      ...
      getEarthData() {
        var p1 = new Promise((resolve, reject) => {
          axios
            .get("https://sss141.tuguan.net:3000/gridChina2017")
            .then((res) => {
              resolve(res.data);
            })
            .catch((err) => {
        ...
        var p2 = new Promise((resolve, reject) => {
          axios
            .get("https://sss141.tuguan.net:3000/gridChina2018")
            .then((res) => {
              resolve(res.data);
            })
            .catch((err) => {
        ...
        var p3 = new Promise((resolve, reject) => {
          axios
            .get("https://sss141.tuguan.net:3000/gridChina2019")
            .then((res) => {
              resolve(res.data);
            })
            .catch((err) => {
        ...
        var p4 = new Promise((resolve, reject) => {
          axios
            .get("https://sss141.tuguan.net:3000/gridChina2020")
            .then((res) => {
              resolve(res.data);
            })
            .catch((err) => {
        ...
        var p5 = new Promise((resolve, reject) => {
          axios
            .get("https://sss141.tuguan.net:3000/gridChina2021")
            .then((res) => {
              resolve(res.data);
            })
            .catch((err) => {
