    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            getToken() {
                ...
                axios({
                    method: "post",
                    url: "https://www.tuguan.net/api/user/v1/visitorScene/" +
            ...
            init(token) {
                ...
                window.appInstance.initService({
                        ...
                        mode: "scene",
                        token: token,
                        url: "https://www.tuguan.net/publish/scene/api/" +
            ...
            addMale(inJsonArr) {
                ...
                let jsonData = {
                    ...
                    columnMinHeight: 1000, // 柱体最小高度（单位：米）
                    ...
                    columnGap: 4000, // 柱体间隙（单位：米）
                    columnWidth: 50000, // 柱体宽度（单位：米）
                    colorMax: "#0000FF", // 最大值颜色（HEX 颜色值）
                    colorMin: "#0000A0", // 最小值颜色（HEX 颜色值）
                    valueMax: 10000000, // 数据最大值上限
                    valueMin: 0, // 数据最小值下限
            ...
            addFemale(inJsonArr) {
                let Data = inJsonArr.map((item, index) => {
                    let _lon = parseFloat(item.lon) + 0.48;
                    return {
                        id: "female" + index,
                        label: "女性",
                        coord: [_lon, item.lat],
