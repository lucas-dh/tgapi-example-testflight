  ...
  var vm = new Vue({
    ...
    methods: {
      ...
      getToken() {
        ...
        axios({
          method: 'post',
          url: 'https://www.tuguan.net/api/user/v1/visitorScene/' + sceneConfig.articulationUrl9,
        }).then((res) => {
        ...
        window.appInstance.initService(
          {
            ...
            mode: 'scene',
            token: token,
            url: 'https://www.tuguan.net/publish/scene/api/' + sceneConfig.articulationUrl9, //模型地址
