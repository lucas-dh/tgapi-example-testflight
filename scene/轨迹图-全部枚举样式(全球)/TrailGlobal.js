    ...
    methods: {
      ...
      addStart(inJsonArr) {
        ...
        let jsonData = {
          ...
          trackDuration: 30, // 尾迹粒子生命周期(单位：秒)
          trackWidth: 10, // 尾迹粒子的宽度
          objLife: 60, // 批号消批时间长度(单位：秒)
          ...
          legends: [
            {
              ...
              iconName: "custom-poiCar", // 内置图标名称：见图观官网统一API开发手册
      ...
      addTrail(inJsonArr) {
        ...
        let jsonData = {
          ...
          duration: 60, // 从上一位置移动到新位置花费的时间长度（单位，秒）这里的值优先级高于 addTrailLayer 中的 duration 值
          data: Data,
        };
